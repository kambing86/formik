(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('react-fast-compare'), require('deepmerge'), require('lodash-es/isPlainObject'), require('lodash-es/clone'), require('lodash-es/toPath'), require('tiny-warning'), require('hoist-non-react-statics'), require('lodash-es/cloneDeep')) :
  typeof define === 'function' && define.amd ? define(['exports', 'react', 'react-fast-compare', 'deepmerge', 'lodash-es/isPlainObject', 'lodash-es/clone', 'lodash-es/toPath', 'tiny-warning', 'hoist-non-react-statics', 'lodash-es/cloneDeep'], factory) :
  (global = global || self, factory(global.formik = {}, global.React, global.isEqual, global.deepmerge, global.isPlainObject, global.clone, global.toPath, global.invariant, global.hoistNonReactStatics, global.cloneDeep));
}(this, (function (exports, React, isEqual, deepmerge, isPlainObject, clone, toPath, invariant, hoistNonReactStatics, cloneDeep) { 'use strict';
  ...
  var _excluded$1 = ["validate", "name", "render", "children", "as", "component"],
  ...
  function Field(_ref) {
    ...
    var _useFormikContext = useFormikContext(),
      formik = _objectWithoutPropertiesLoose(_useFormikContext, _excluded2);
    {
      // eslint-disable-next-line react-hooks/rules-of-hooks
      React.useEffect(function () {
    ...
    if (typeof asElement === 'string') {
      var _innerRef = props.innerRef,
        _rest = _objectWithoutPropertiesLoose(props, _excluded4);
  ...
  var _excluded$3 = ["mapPropsToValues"],
  ...
  var _excluded$4 = ["validate", "validationSchema"];
  /**
   * Some array helpers!
   */
  ...
  var FieldArrayInner = /*#__PURE__*/function (_React$Component) {
    ...
    _proto.render = function render() {
      ...
      var _this$props2 = this.props,
        ...
        restOfFormik = _objectWithoutPropertiesLoose(_this$props2$formik, _excluded$4);
  ...
  var _excluded$5 = ["component", "formik", "render", "children", "name"];
  ...
  var _excluded$6 = ["validate", "name", "render", "as", "children", "component", "shouldUpdate", "formik"],
    _excluded2$2 = ["validate", "validationSchema"],
    _excluded3$1 = ["innerRef"],
    _excluded4$1 = ["innerRef"];
  /**
  ...
  var FastFieldInner = /*#__PURE__*/function (_React$Component) {
    ...
    _proto.render = function render() {
      ...
      var restOfFormik = _objectWithoutPropertiesLoose(formik, _excluded2$2);
      var field = formik.getFieldProps(_extends({
        name: name
      }, props));
      var meta = {
      ...
      if (typeof asElement === 'string') {
        var _innerRef = props.innerRef,
          _rest = _objectWithoutPropertiesLoose(props, _excluded4$1);
        return React.createElement(asElement, _extends({
          ref: _innerRef
        }, field, _rest), children);
      }
